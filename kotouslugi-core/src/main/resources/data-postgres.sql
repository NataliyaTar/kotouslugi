...
(1, 'linear-gradient(86deg, #EDF2FE 0%, #F0FFF2 100%)', 'Случилось несчастье', 'Новая услуга на портале «Поддержка в сложной ситуации» поможет быстро найти нужные сервисы', 'ghost.png'),
